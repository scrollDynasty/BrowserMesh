...
| `browser_console_list`         | page address, `sinceEventId?`, `limit?`, `includeText?` | event page                                                |
| `browser_page_errors_list`     | same as console                                         | event page                                                |
| `browser_network_list`         | page address, `sinceEventId?`, `limit?`                 | event page                                                |
| `browser_failed_requests_list` | same as network                                         | event page                                                |
