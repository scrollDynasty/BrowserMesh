...
* deliver agent guidelines through MCP server instructions ([#67](https://github.com/scrollDynasty/BrowserMesh/issues/67)) ([d072f1e](https://github.com/scrollDynasty/BrowserMesh/commit/d072f1e459f1853ca3629fe19b13143d288a1dc6))
...
* name the package consistently in the lockfile ([#53](https://github.com/scrollDynasty/multi-agent-browser-mcp/issues/53)) ([a89efd9](https://github.com/scrollDynasty/multi-agent-browser-mcp/commit/a89efd99215db39376cc4be66ab9681ab0c7bf6e))

## [0.2.0](https://github.com/scrollDynasty/multi-agent-browser-mcp/compare/v0.1.5...v0.2.0) (2026-08-17)


### ⚠ BREAKING CHANGES

* cut discovery cost and remove first-run friction ([#49](https://github.com/scrollDynasty/multi-agent-browser-mcp/issues/49))

### Features

* cut discovery cost and remove first-run friction ([#49](https://github.com/scrollDynasty/multi-agent-browser-mcp/issues/49)) ([54d8a44](https://github.com/scrollDynasty/multi-agent-browser-mcp/commit/54d8a44b810d26b17c52651b770470be3688ea2f))
