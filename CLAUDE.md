...
| `npm run test:integration` | real Chromium (`tests/integration`) — 84 tests           |
...
`npm run verify` is the release gate and takes ~72s: all 266 tests under coverage thresholds
