...
| Bounded snapshots, context options, typed interactions | Partial: bounded scoped snapshots, interactive tree controls, immutable cursor pagination, safe context settings including origin-scoped geolocation, short-lived refs, hover/focus/check/double-click/scroll/scroll-into-view/drag-drop, viewport/full-page/element in-memory screenshots, popup, and dialog complete; remaining lifecycle-heavy interactions pending | ADRs 0011, 0013, 0015, 0016 |
