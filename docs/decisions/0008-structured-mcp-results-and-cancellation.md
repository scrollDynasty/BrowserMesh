...
abort, returns stable `OPERATION_CANCELLED`, and does not poison the session queue. Progress is used
only for genuinely multi-step work with honest monotonic progress.
